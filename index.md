...
- ESWJ index：veraging the zonal wind speed over the region shown in Fig. 1a
...
4. 総合結論（Conclusion）
図1・図2に示された「空間的な弱体化パターンの一致」と、図3に示された「定量的なトレンドの整合性および統計的な有意性」を総合すると、過去40年間にわたる**ユーラシア亜熱帯ジェット（ESWJ）の弱体化は、主として人為起源エアロゾルの排出（AER）によって引き起こされた**と結論付けられる。
